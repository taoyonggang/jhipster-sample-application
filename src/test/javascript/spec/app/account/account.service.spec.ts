...
describe('Account Service test suite', () => {
  ...
  it('should init service and do not retrieve account', async () => {
    ...
    accountService = await new AccountService(store, new TranslationService(store, i18n), cookie, null, router);
  ...
  it('should init service and retrieve profiles if already logged in before but no account found', async () => {
    ...
    accountService = await new AccountService(store, new TranslationService(store, i18n), mockedCookie, null, router);
  ...
  it('should init service and check for authority after retrieving account but getAccount failed', async () => {
    ...
    accountService = await new AccountService(store, new TranslationService(store, i18n), mockedCookie, trackerService, router);
